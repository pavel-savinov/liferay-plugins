 ...
 * @generated
 */
public class PlaceholderLocalServiceClp implements PlaceholderLocalService {
    ...
    public PlaceholderLocalServiceClp(
        ...
        _methodName22 = "deletePlaceholders";

        _methodParameterTypes22 = new String[] { "long" };

        _methodName23 = "getPlaceholders";

        _methodParameterTypes23 = new String[] { "long" };

        _methodName24 = "getPlaceholdersCount";
    ...
    public com.liferay.consumer.manager.extension.screens.model.Placeholder addPlaceholder(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(placeholder) });
        } catch (Throwable t) {
    ...
    public com.liferay.consumer.manager.extension.screens.model.Placeholder createPlaceholder(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { placeholderId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.liferay.consumer.manager.extension.screens.model.Placeholder deletePlaceholder(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { placeholderId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.liferay.consumer.manager.extension.screens.model.Placeholder fetchPlaceholder(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { placeholderId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.liferay.consumer.manager.extension.screens.model.Placeholder getPlaceholder(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName12,
                    _methodParameterTypes12, new Object[] { placeholderId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public int getPlaceholdersCount(long consumerId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName24,
                    _methodParameterTypes24, new Object[] { consumerId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
